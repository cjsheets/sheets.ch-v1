...
export interface imageSharpGroupConnectionConnection {
  pageInfo: PageInfo; /** Information to aid in pagination. */
  edges?: (imageSharpGroupConnectionEdge | null)[] | null; /** A list of edges. */
  field?: string | null; 
  fieldValue?: string | null; 
  totalCount?: number | null; 
}
...
export namespace RootQueryTypeResolvers {
  ...
  export type AllSitePageResolver = Resolver<SitePageConnection | null, AllSitePageArgs>;
  ...
  export type AllSitePluginResolver = Resolver<SitePluginConnection | null, AllSitePluginArgs>;
  ...
  export type AllDirectoryResolver = Resolver<DirectoryConnection | null, AllDirectoryArgs>;
  ...
  export type AllImageSharpResolver = Resolver<ImageSharpConnection | null, AllImageSharpArgs>;
  ...
  export type AllMarkdownRemarkResolver = Resolver<MarkdownRemarkConnection | null, AllMarkdownRemarkArgs>;
  ...
  export type MarkdownRemarkResolver = Resolver<MarkdownRemark | null, MarkdownRemarkArgs>;
...
export namespace SitePageConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(SitePageEdge | null)[] | null>;  export type TotalCountResolver = Resolver<number | null>;  export type DistinctResolver = Resolver<(string | null)[] | null, DistinctArgs>;
  export interface DistinctArgs {
    field?: sitePageDistinctEnum | null; 
  }

  export type GroupResolver = Resolver<(sitePageGroupConnectionConnection | null)[] | null, GroupArgs>;
...
export namespace SitePageEdgeResolvers {
  ...
  export type NodeResolver = Resolver<SitePage | null>;  export type NextResolver = Resolver<SitePage | null>;  export type PreviousResolver = Resolver<SitePage | null>;  
}
/** Node of type SitePage */
export namespace SitePageResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type JsonNameResolver = Resolver<string | null>;  export type InternalComponentNameResolver = Resolver<string | null>;  export type PathResolver = Resolver<string | null>;  export type ComponentResolver = Resolver<string | null>;  export type ComponentChunkNameResolver = Resolver<string | null>;  export type ContextResolver = Resolver<context | null>;  export type PluginCreatorResolver = Resolver<SitePlugin | null>;  export type PluginCreatorIdResolver = Resolver<string | null>;  export type ComponentPathResolver = Resolver<string | null>;  export type InternalResolver = Resolver<internal_8 | null>;  
}
...
export namespace contextResolvers {
  ...
  export type SlugResolver = Resolver<string | null>;  export type PreviousResolver = Resolver<previous | null>;  export type NextResolver = Resolver<next | null>;  
}
...
export namespace previousResolvers {
  ...
  export type FieldsResolver = Resolver<fields_2 | null>;  export type FrontmatterResolver = Resolver<frontmatter_2 | null>;  
}
...
export namespace nextResolvers {
  ...
  export type FieldsResolver = Resolver<fields_3 | null>;  export type FrontmatterResolver = Resolver<frontmatter_3 | null>;  
}
...
export namespace SitePluginResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type ResolveResolver = Resolver<string | null>;  export type NameResolver = Resolver<string | null>;  export type VersionResolver = Resolver<string | null>;  export type PluginOptionsResolver = Resolver<pluginOptions_3 | null>;  export type NodeAPIsResolver = Resolver<(string | null)[] | null>;  export type BrowserAPIsResolver = Resolver<(string | null)[] | null>;  export type SsrAPIsResolver = Resolver<(string | null)[] | null>;  export type PluginFilepathResolver = Resolver<string | null>;  export type PackageJsonResolver = Resolver<packageJson_2 | null>;  export type InternalResolver = Resolver<internal_9 | null>;  
}
...
export namespace pluginOptions_3Resolvers {
  export interface Resolvers {
    ...
    ignoreFileExtensions?: IgnoreFileExtensionsResolver; 
    pathCheck?: PathCheckResolver; 
  }

  export type PluginsResolver = Resolver<(plugins_2 | null)[] | null>;  export type PathResolver = Resolver<string | null>;  export type NameResolver = Resolver<string | null>;  export type MaxWidthResolver = Resolver<number | null>;  export type WrapperStyleResolver = Resolver<string | null>;  export type BackgroundColorResolver = Resolver<string | null>;  export type LinkImagesToOriginalResolver = Resolver<boolean | null>;  export type ShowCaptionsResolver = Resolver<boolean | null>;  export type PathPrefixResolver = Resolver<string | null>;  export type IgnoreFileExtensionsResolver = Resolver<(string | null)[] | null>;  export type PathCheckResolver = Resolver<boolean | null>;  
}
...
export namespace plugins_2Resolvers {
  ...
  export type ResolveResolver = Resolver<string | null>;  export type IdResolver = Resolver<string | null>;  export type NameResolver = Resolver<string | null>;  export type VersionResolver = Resolver<string | null>;  export type PluginOptionsResolver = Resolver<pluginOptions_4 | null>;  export type PluginFilepathResolver = Resolver<string | null>;  
}
...
export namespace pluginOptions_4Resolvers {
  ...
  export type MaxWidthResolver = Resolver<number | null>;  export type WrapperStyleResolver = Resolver<string | null>;  export type BackgroundColorResolver = Resolver<string | null>;  export type LinkImagesToOriginalResolver = Resolver<boolean | null>;  export type ShowCaptionsResolver = Resolver<boolean | null>;  export type PathPrefixResolver = Resolver<string | null>;  export type IgnoreFileExtensionsResolver = Resolver<(string | null)[] | null>;  
}
...
export namespace packageJson_2Resolvers {
  ...
  export type NameResolver = Resolver<string | null>;  export type DescriptionResolver = Resolver<string | null>;  export type VersionResolver = Resolver<string | null>;  export type MainResolver = Resolver<string | null>;  export type AuthorResolver = Resolver<string | null>;  export type LicenseResolver = Resolver<string | null>;  export type DependenciesResolver = Resolver<(dependencies_2 | null)[] | null>;  export type DevDependenciesResolver = Resolver<(devDependencies_2 | null)[] | null>;  export type PeerDependenciesResolver = Resolver<(peerDependencies_2 | null)[] | null>;  export type KeywordsResolver = Resolver<(string | null)[] | null>;  
}
...
export namespace dependencies_2Resolvers {
  ...
  export type NameResolver = Resolver<string | null>;  export type VersionResolver = Resolver<string | null>;  
}
...
export namespace internal_9Resolvers {
  ...
  export type ContentDigestResolver = Resolver<string | null>;  export type TypeResolver = Resolver<string | null>;  export type OwnerResolver = Resolver<string | null>;  
}
...
export namespace internal_8Resolvers {
  ...
  export type TypeResolver = Resolver<string | null>;  export type ContentDigestResolver = Resolver<string | null>;  export type DescriptionResolver = Resolver<string | null>;  export type OwnerResolver = Resolver<string | null>;  
}
/** A connection to a list of items. */
export namespace sitePageGroupConnectionConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(sitePageGroupConnectionEdge | null)[] | null>;  export type FieldResolver = Resolver<string | null>;  export type FieldValueResolver = Resolver<string | null>;  export type TotalCountResolver = Resolver<number | null>;  
}
/** An edge in a connection. */
...
export namespace SitePluginConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(SitePluginEdge | null)[] | null>;  export type TotalCountResolver = Resolver<number | null>;  export type DistinctResolver = Resolver<(string | null)[] | null, DistinctArgs>;
  export interface DistinctArgs {
    field?: sitePluginDistinctEnum | null; 
  }

  export type GroupResolver = Resolver<(sitePluginGroupConnectionConnection | null)[] | null, GroupArgs>;
  export interface GroupArgs {
    skip?: number | null; 
    limit?: number | null; 
...
export namespace SitePluginEdgeResolvers {
  ...
  export type NodeResolver = Resolver<SitePlugin | null>;  export type NextResolver = Resolver<SitePlugin | null>;  export type PreviousResolver = Resolver<SitePlugin | null>;  
}
/** A connection to a list of items. */
export namespace sitePluginGroupConnectionConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(sitePluginGroupConnectionEdge | null)[] | null>;  export type FieldResolver = Resolver<string | null>;  export type FieldValueResolver = Resolver<string | null>;  export type TotalCountResolver = Resolver<number | null>;  
}
/** An edge in a connection. */
...
export namespace DirectoryConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(DirectoryEdge | null)[] | null>;  export type TotalCountResolver = Resolver<number | null>;  export type DistinctResolver = Resolver<(string | null)[] | null, DistinctArgs>;
  export interface DistinctArgs {
    field?: directoryDistinctEnum | null; 
  }

  export type GroupResolver = Resolver<(directoryGroupConnectionConnection | null)[] | null, GroupArgs>;
  export interface GroupArgs {
    skip?: number | null; 
    limit?: number | null; 
...
export namespace DirectoryEdgeResolvers {
  ...
  export type NodeResolver = Resolver<Directory | null>;  export type NextResolver = Resolver<Directory | null>;  export type PreviousResolver = Resolver<Directory | null>;  
}
/** Node of type Directory */
export namespace DirectoryResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type InternalResolver = Resolver<internal_10 | null>;  export type SourceInstanceNameResolver = Resolver<string | null>;  export type AbsolutePathResolver = Resolver<string | null>;  export type RelativePathResolver = Resolver<string | null>;  export type ExtensionResolver = Resolver<string | null>;  export type SizeResolver = Resolver<number | null>;  export type PrettySizeResolver = Resolver<string | null>;  export type ModifiedTimeResolver = Resolver<Date | null, ModifiedTimeArgs>;
  ...
  export type RootResolver = Resolver<string | null>;  export type DirResolver = Resolver<string | null>;  export type BaseResolver = Resolver<string | null>;  export type ExtResolver = Resolver<string | null>;  export type NameResolver = Resolver<string | null>;  export type RelativeDirectoryResolver = Resolver<string | null>;  export type DevResolver = Resolver<number | null>;  export type ModeResolver = Resolver<number | null>;  export type NlinkResolver = Resolver<number | null>;  export type UidResolver = Resolver<number | null>;  export type GidResolver = Resolver<number | null>;  export type RdevResolver = Resolver<number | null>;  export type BlksizeResolver = Resolver<number | null>;  export type InoResolver = Resolver<number | null>;  export type BlocksResolver = Resolver<number | null>;  export type AtimeMsResolver = Resolver<number | null>;  export type MtimeMsResolver = Resolver<number | null>;  export type CtimeMsResolver = Resolver<number | null>;  export type BirthtimeMsResolver = Resolver<number | null>;  export type AtimeResolver = Resolver<Date | null, AtimeArgs>;
...
export namespace internal_10Resolvers {
  ...
  export type ContentDigestResolver = Resolver<string | null>;  export type TypeResolver = Resolver<string | null>;  export type DescriptionResolver = Resolver<string | null>;  export type OwnerResolver = Resolver<string | null>;  
}
/** A connection to a list of items. */
export namespace directoryGroupConnectionConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(directoryGroupConnectionEdge | null)[] | null>;  export type FieldResolver = Resolver<string | null>;  export type FieldValueResolver = Resolver<string | null>;  export type TotalCountResolver = Resolver<number | null>;  
}
/** An edge in a connection. */
...
export namespace FileConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(FileEdge | null)[] | null>;  export type TotalCountResolver = Resolver<number | null>;  export type DistinctResolver = Resolver<(string | null)[] | null, DistinctArgs>;
  export interface DistinctArgs {
    field?: fileDistinctEnum | null; 
  }

  export type GroupResolver = Resolver<(fileGroupConnectionConnection | null)[] | null, GroupArgs>;
  export interface GroupArgs {
    skip?: number | null; 
    limit?: number | null; 
...
export namespace FileEdgeResolvers {
  ...
  export type NodeResolver = Resolver<File | null>;  export type NextResolver = Resolver<File | null>;  export type PreviousResolver = Resolver<File | null>;  
}
/** Node of type File */
export namespace FileResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type ChildMarkdownRemarkResolver = Resolver<MarkdownRemark | null>;  export type ChildImageSharpResolver = Resolver<ImageSharp | null>;  export type InternalResolver = Resolver<internal_11 | null>;  export type SourceInstanceNameResolver = Resolver<string | null>;  export type AbsolutePathResolver = Resolver<string | null>;  export type RelativePathResolver = Resolver<string | null>;  export type ExtensionResolver = Resolver<string | null>;  export type SizeResolver = Resolver<number | null>;  export type PrettySizeResolver = Resolver<string | null>;  export type ModifiedTimeResolver = Resolver<Date | null, ModifiedTimeArgs>;
  export interface ModifiedTimeArgs {
    formatString?: string | null; /** Format the date using Moment.js' date tokens e.g. "date(formatString: "YYYY MMMM DD)" See https://momentjs.com/docs/#/displaying/format/ for documentation for different tokens */
    fromNow?: boolean | null; /** Returns a string generated with Moment.js' fromNow function */
    difference?: string | null; /** Returns the difference between this date and the current time. Defaults to miliseconds but you can also pass in as the measurement years, months, weeks, days, hours, minutes, and seconds. */
...
export namespace MarkdownRemarkResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type InternalResolver = Resolver<internal_12 | null>;  export type FrontmatterResolver = Resolver<frontmatter_4 | null>;  export type RawMarkdownBodyResolver = Resolver<string | null>;  export type FileAbsolutePathResolver = Resolver<string | null>;  export type FieldsResolver = Resolver<fields_4 | null>;  export type HtmlResolver = Resolver<string | null>;  export type HtmlAstResolver = Resolver<JSON | null>;  export type ExcerptResolver = Resolver<string | null, ExcerptArgs>;
  export interface ExcerptArgs {
    pruneLength?: number | null; 
  }

  export type HeadingsResolver = Resolver<(MarkdownHeading | null)[] | null, HeadingsArgs>;
  export interface HeadingsArgs {
    depth?: HeadingLevels | null; 
  }

  export type TimeToReadResolver = Resolver<number | null>;  export type TableOfContentsResolver = Resolver<string | null>;  export type WordCountResolver = Resolver<wordCount | null>;  
}
...
export namespace internal_12Resolvers {
  ...
  export type ContentResolver = Resolver<string | null>;  export type TypeResolver = Resolver<string | null>;  export type ContentDigestResolver = Resolver<string | null>;  export type OwnerResolver = Resolver<string | null>;  export type FieldOwnersResolver = Resolver<fieldOwners_2 | null>;  
}
...
export namespace frontmatter_4Resolvers {
  ...
  export type TitleResolver = Resolver<string | null>;  export type _PARENTResolver = Resolver<string | null>;  export type CreatedDateResolver = Resolver<Date | null, CreatedDateArgs>;
  ...
  export type AuthorResolver = Resolver<string | null>;  export type TagsResolver = Resolver<(string | null)[] | null>;  export type DraftResolver = Resolver<boolean | null>;  
}
...
export namespace MarkdownHeadingResolvers {
  ...
  export type ValueResolver = Resolver<string | null>;  export type DepthResolver = Resolver<number | null>;  
}
...
export namespace wordCountResolvers {
  ...
  export type ParagraphsResolver = Resolver<number | null>;  export type SentencesResolver = Resolver<number | null>;  export type WordsResolver = Resolver<number | null>;  
}
/** Node of type ImageSharp */
export namespace ImageSharpResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type InternalResolver = Resolver<internal_13 | null>;  export type FixedResolver = Resolver<ImageSharpFixed | null, FixedArgs>;
  ...
  export type ResolutionsResolver = Resolver<ImageSharpResolutions | null, ResolutionsArgs>;
  ...
  export type FluidResolver = Resolver<ImageSharpFluid | null, FluidArgs>;
  ...
  export type OriginalResolver = Resolver<ImageSharpOriginal | null>;  export type ResizeResolver = Resolver<ImageSharpResize | null, ResizeArgs>;
...
export namespace ImageSharpFixedResolvers {
  ...
  export type Base64Resolver = Resolver<string | null>;  export type TracedSVGResolver = Resolver<string | null>;  export type AspectRatioResolver = Resolver<number | null>;  export type WidthResolver = Resolver<number | null>;  export type HeightResolver = Resolver<number | null>;  export type SrcResolver = Resolver<string | null>;  export type SrcSetResolver = Resolver<string | null>;  export type SrcWebpResolver = Resolver<string | null>;  export type SrcSetWebpResolver = Resolver<string | null>;  export type OriginalNameResolver = Resolver<string | null>;  
}
...
export namespace ImageSharpFluidResolvers {
  ...
  export type Base64Resolver = Resolver<string | null>;  export type TracedSVGResolver = Resolver<string | null>;  export type AspectRatioResolver = Resolver<number | null>;  export type SrcResolver = Resolver<string | null>;  export type SrcSetResolver = Resolver<string | null>;  export type SrcWebpResolver = Resolver<string | null>;  export type SrcSetWebpResolver = Resolver<string | null>;  export type SizesResolver = Resolver<string | null>;  export type OriginalImgResolver = Resolver<string | null>;  export type OriginalNameResolver = Resolver<string | null>;  
}
...
export namespace ImageSharpOriginalResolvers {
  ...
  export type WidthResolver = Resolver<number | null>;  export type HeightResolver = Resolver<number | null>;  export type SrcResolver = Resolver<string | null>;  
}
...
export namespace ImageSharpResizeResolvers {
  ...
  export type SrcResolver = Resolver<string | null>;  export type TracedSVGResolver = Resolver<string | null>;  export type WidthResolver = Resolver<number | null>;  export type HeightResolver = Resolver<number | null>;  export type AspectRatioResolver = Resolver<number | null>;  export type OriginalNameResolver = Resolver<string | null>;  
}
...
export namespace internal_11Resolvers {
  ...
  export type ContentDigestResolver = Resolver<string | null>;  export type TypeResolver = Resolver<string | null>;  export type MediaTypeResolver = Resolver<string | null>;  export type DescriptionResolver = Resolver<string | null>;  export type OwnerResolver = Resolver<string | null>;  
}
/** A connection to a list of items. */
export namespace fileGroupConnectionConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(fileGroupConnectionEdge | null)[] | null>;  export type FieldResolver = Resolver<string | null>;  export type FieldValueResolver = Resolver<string | null>;  export type TotalCountResolver = Resolver<number | null>;  
}
/** An edge in a connection. */
...
export namespace ImageSharpConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(ImageSharpEdge | null)[] | null>;  export type TotalCountResolver = Resolver<number | null>;  export type DistinctResolver = Resolver<(string | null)[] | null, DistinctArgs>;
  export interface DistinctArgs {
    field?: imageSharpDistinctEnum | null; 
  }

  export type GroupResolver = Resolver<(imageSharpGroupConnectionConnection | null)[] | null, GroupArgs>;
  export interface GroupArgs {
    skip?: number | null; 
    limit?: number | null; 
...
export namespace ImageSharpEdgeResolvers {
  ...
  export type NodeResolver = Resolver<ImageSharp | null>;  export type NextResolver = Resolver<ImageSharp | null>;  export type PreviousResolver = Resolver<ImageSharp | null>;  
}
/** A connection to a list of items. */
export namespace imageSharpGroupConnectionConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(imageSharpGroupConnectionEdge | null)[] | null>;  export type FieldResolver = Resolver<string | null>;  export type FieldValueResolver = Resolver<string | null>;  export type TotalCountResolver = Resolver<number | null>;  
}
/** An edge in a connection. */
...
export namespace MarkdownRemarkConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(MarkdownRemarkEdge | null)[] | null>;  export type TotalCountResolver = Resolver<number | null>;  export type DistinctResolver = Resolver<(string | null)[] | null, DistinctArgs>;
  export interface DistinctArgs {
    field?: markdownRemarkDistinctEnum | null; 
  }

  export type GroupResolver = Resolver<(markdownRemarkGroupConnectionConnection | null)[] | null, GroupArgs>;
  export interface GroupArgs {
    skip?: number | null; 
    limit?: number | null; 
...
export namespace MarkdownRemarkEdgeResolvers {
  ...
  export type NodeResolver = Resolver<MarkdownRemark | null>;  export type NextResolver = Resolver<MarkdownRemark | null>;  export type PreviousResolver = Resolver<MarkdownRemark | null>;  
}
/** A connection to a list of items. */
export namespace markdownRemarkGroupConnectionConnectionResolvers {
  ...
  export type PageInfoResolver = Resolver<PageInfo>;  export type EdgesResolver = Resolver<(markdownRemarkGroupConnectionEdge | null)[] | null>;  export type FieldResolver = Resolver<string | null>;  export type FieldValueResolver = Resolver<string | null>;  export type TotalCountResolver = Resolver<number | null>;  
}
/** An edge in a connection. */
...
export namespace SiteResolvers {
  ...
  export type IdResolver = Resolver<string>;  export type ParentResolver = Resolver<Node | null>;  export type ChildrenResolver = Resolver<(Node | null)[] | null>;  export type SiteMetadataResolver = Resolver<siteMetadata_2 | null>;  export type PortResolver = Resolver<Date | null, PortArgs>;
  ...
  export type HostResolver = Resolver<string | null>;  export type PathPrefixResolver = Resolver<string | null>;  export type PolyfillResolver = Resolver<boolean | null>;  export type BuildTimeResolver = Resolver<Date | null, BuildTimeArgs>;
...
export namespace siteMetadata_2Resolvers {
  ...
  export type SiteNameResolver = Resolver<string | null>;  export type TitleResolver = Resolver<string | null>;  export type AuthorResolver = Resolver<string | null>;  export type DescriptionResolver = Resolver<string | null>;  export type SiteUrlResolver = Resolver<string | null>;  
}
...
export interface sitePageConnectionPluginCreatorPluginOptionsPluginsQueryList {
  in?: (sitePageConnectionPluginCreatorPluginOptionsPluginsInputObject | null)[] | null; 
}
...
export interface sitePageConnectionPluginCreatorPackageJsonDependenciesQueryList {
  in?: (sitePageConnectionPluginCreatorPackageJsonDependenciesInputObject | null)[] | null; 
}
...
export interface sitePageConnectionPluginCreatorPackageJsonDevDependenciesQueryList {
  in?: (sitePageConnectionPluginCreatorPackageJsonDevDependenciesInputObject | null)[] | null; 
}
...
export interface sitePageConnectionPluginCreatorPackageJsonPeerDependenciesQueryList {
  in?: (sitePageConnectionPluginCreatorPackageJsonPeerDependenciesInputObject | null)[] | null; 
}
...
export interface sitePluginConnectionPackageJsonDependenciesQueryList_2 {
  in?: (sitePluginConnectionPackageJsonDependenciesInputObject_2 | null)[] | null; 
}
...
export interface sitePluginConnectionPackageJsonDevDependenciesQueryList_2 {
  in?: (sitePluginConnectionPackageJsonDevDependenciesInputObject_2 | null)[] | null; 
}
...
export interface sitePluginConnectionPackageJsonPeerDependenciesQueryList_2 {
  in?: (sitePluginConnectionPackageJsonPeerDependenciesInputObject_2 | null)[] | null; 
}
...
export interface sitePagePluginCreatorPackageJsonDevDependenciesQueryList {
  in?: (sitePagePluginCreatorPackageJsonDevDependenciesInputObject | null)[] | null; 
}
...
export interface sitePagePluginCreatorPackageJsonPeerDependenciesQueryList {
  in?: (sitePagePluginCreatorPackageJsonPeerDependenciesInputObject | null)[] | null; 
}
